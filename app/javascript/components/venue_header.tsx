...
export const VenueHeader = ({ seatsPerRow, setTicketsToBuyCount }: VenueHeaderProps): React.ReactElement => {
  const setTicketsOnCgange = (event: React.SyntheticEvent): void => {
  ...
  return (
    <div>
      ...
      <span className="select">
        <select onChange={setTicketsOnCgange}>
          {options(seatsPerRow)}
        </select>
      </span>
    </div>
